...
public class TurboSecondItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turbo_second_item);
        da = new DataAccessLayer(this);

        secondQ = (TextView)findViewById(R.id.turbo_second_question);
        ...
        if (turboQuizSet) {
            Cursor c = da.getTurboQuizSetByItemNo(2);
            if (c.getCount() > 0) {
                c.moveToFirst();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TurboSecondItemActivity.this, TurboFirstItemActivity.class);
                startActivity(intent);
                finish();
            }
        });
